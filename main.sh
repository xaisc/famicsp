...
svn export https://github.com/kiddin9/openwrt-packages/trunk/luci-app-adguardhome && sed -i 's/\/etc\/AdGuardHome.yaml/\/etc\/adguardhome.yaml/g' luci-app-adguardhome/Makefile
